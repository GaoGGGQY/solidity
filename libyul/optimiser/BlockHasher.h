...
*/
/**
 * Optimiser component that calculates hash values for block prefixes and suffices.
 */
#pragma once
...
struct BlockPart {
	...
	{
		return std::make_tuple(block, start, end) < std::make_tuple(_rhs.block, _rhs.start, _rhs.end);
	}
};
